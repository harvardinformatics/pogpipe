...
from   datamodel.ParallelMpileupAnalysis import ParallelMpileupAnalysis
...
class ObjectCreateCheck(unittest.TestCase):          # Class with unitttest.TestCase as arg - 
    ...
    def setUp(self):
        ...
        self.input_files = ["/Users/mclamp/HC119_CGATGT.R1.fastq.gz.trimmed.bam"]
    ...
    def testRun(self):
        ...
        self.ana = AnalysisFactory.createAnalysisFromModuleName("ParallelMpileup")
